...
export class ClientTableComponent implements OnDestroy, OnChanges, AfterViewInit{
  ...
  @Output() public confirmDelete = new EventEmitter<ClientModelTable>()

  @Output() public requestUpdate = new EventEmitter<ClientModelTable>()
